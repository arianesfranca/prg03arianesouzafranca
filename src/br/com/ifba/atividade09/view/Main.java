...
public class Main {
    public static void main(String[] args) {
        ...
        // Percorre todas as formas do array
        for (Forma f : formas) {
            System.out.println("---------------------------");
            System.out.println(f.toString());

            // Se for 2D, exibe apenas a área
            if (f instanceof Forma2D) {
                Forma2D f2d = (Forma2D) f;
                System.out.printf("Area: %.2f%n", f2d.obterArea());

            // Se for 3D, exibe área e volume
            } else if (f instanceof Forma3D) {
                Forma3D f3d = (Forma3D) f;
                System.out.printf("Area: %.2f%n", f3d.obterArea());
